...
_XLIGHTS_EFFECT_DEFAULTS: dict[str, dict[str, str]] = {
    ...
    "Ripple": {
        "E_CHECKBOX_Ripple_3D": "0",
        "E_CHOICE_Ripple_Movement": "None",
    ...
    "Spirals": {
        ...
        "E_CHOICE_Spirals_Direction": "Right",
    ...
    "Liquid": {
        "E_CHECKBOX_Liquid_MixColors": "0",
        "E_CHOICE_Liquid_Direction": "Left",
        "E_SLIDER_Liquid_GravityAngle": "0",
        "E_SLIDER_Liquid_Speed": "10",
        "E_SLIDER_Liquid_TopBarrier": "0",
        "E_SLIDER_Liquid_BottomBarrier": "0",
    },
    "Galaxy": {
